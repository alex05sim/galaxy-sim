...
BODY_DATA = {
    'SUN': {'mass': 1.989e30, 'type': 'star'},
    'MERCURY': {'mass': 3.3011e23, 'type': 'planet'},
    'VENUS': {'mass': 4.8675e24, 'type': 'planet'},
    'EARTH': {'mass': 5.972e24, 'type': 'planet'},
...
def load_bodies_from_spice(spk_path, et):
    ...
    for body_id in ids:
        ...
        b = Body(name=clean_name, position=pos_m, velocity=vel_m_s,
                 mass=body_info['mass'], body_type=body_info['type'], parent=parent)
        bodies.append(b)
